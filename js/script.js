...
// Написал специально через переменные для других программистов, чтоб было понятно=)
// let secondInMinute = 60;
// let secondInHour = 60 * secondInMinute;
// let secondInDay = secondInHour * 24;
// let secondInMonthJanuary = secondInDay * 31;
// console.log(secondInHour);
// console.log(secondInDay);
// console.log(secondInMonthJanuary);
